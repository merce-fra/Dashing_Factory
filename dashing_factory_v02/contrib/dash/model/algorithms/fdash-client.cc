...
FdashClient::CalcNextSegment (uint32_t currRate, uint32_t &nextRate, Time &delay)
{
  ...
  NS_LOG_INFO ("    ------------------------------------------------------");
  NS_LOG_INFO ("    [" << Simulator::Now () << "] FdashClient::CalcNextSegment () ");
  ...
  NS_LOG_INFO ("                                  start by requesting  currDt = GetBufferEstimate ()");
  NS_LOG_INFO ("                                                         diff = GetBufferDifferential ();");      
  ...
  NS_LOG_INFO ("                                                         At the end ...");          
  NS_LOG_INFO ("                                                         nextRate = " << nextRate );
  NS_LOG_INFO ("                                                         delay = " << delay );    
  NS_LOG_INFO ("    [" << Simulator::Now () << "] FdashClient::CalcNextSegment  DONE  ");
  NS_LOG_INFO ("    ----------------------------------------------------------------");  
