...
//**	INDOOR FACTORY SCENARIOS -  iTEAM UPV

static void
InitInF_SL(ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
...
static void
InitInF_SL_nLoS (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
  pathlossModelFactory->SetTypeId (ThreeGppIndoorFactorySLPropagationLossModel::GetTypeId ());
  channelConditionModelFactory->SetTypeId (NeverLosChannelConditionModel::GetTypeId ());
}
...
static void
InitInF_DL (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
...
static void
InitInF_DL_nLoS (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
  pathlossModelFactory->SetTypeId (ThreeGppIndoorFactoryDLPropagationLossModel::GetTypeId ());
  channelConditionModelFactory->SetTypeId (NeverLosChannelConditionModel::GetTypeId ());
}
...
static void
InitInF_SH (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
...
static void
InitInF_SH_nLoS (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
  pathlossModelFactory->SetTypeId (ThreeGppIndoorFactorySHPropagationLossModel::GetTypeId ());
  channelConditionModelFactory->SetTypeId (NeverLosChannelConditionModel::GetTypeId ());
}
...
static void
InitInF_DH (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
...
static void
InitInF_DH_nLoS (ObjectFactory *pathlossModelFactory, ObjectFactory *channelConditionModelFactory)
{
  pathlossModelFactory->SetTypeId (ThreeGppIndoorFactoryDHPropagationLossModel::GetTypeId ());
  channelConditionModelFactory->SetTypeId (NeverLosChannelConditionModel::GetTypeId ());
}
...
NrHelper::InitializeOperationBand (OperationBandInfo *band, uint8_t flags)
{
  ...
  static std::unordered_map<BandwidthPartInfo::Scenario, InitPathLossFn, std::hash<int>> initLookupTable
  {
	...
	{BandwidthPartInfo::InF_SL, std::bind (&InitInF_SL, std::placeholders::_1, std::placeholders::_2) },
	{BandwidthPartInfo::InF_SL_nLoS, std::bind (&InitInF_SL_nLoS, std::placeholders::_1, std::placeholders::_2)},
	{BandwidthPartInfo::InF_DL, std::bind (&InitInF_DL, std::placeholders::_1, std::placeholders::_2) },
	{BandwidthPartInfo::InF_DL_nLoS, std::bind (&InitInF_DL_nLoS, std::placeholders::_1, std::placeholders::_2)},
	{BandwidthPartInfo::InF_SH, std::bind (&InitInF_SH, std::placeholders::_1, std::placeholders::_2) },
	{BandwidthPartInfo::InF_SH_nLoS, std::bind (&InitInF_SH_nLoS, std::placeholders::_1, std::placeholders::_2)},
	{BandwidthPartInfo::InF_DH, std::bind (&InitInF_DH, std::placeholders::_1, std::placeholders::_2) },
	{BandwidthPartInfo::InF_DH_nLoS, std::bind (&InitInF_DH_nLoS, std::placeholders::_1, std::placeholders::_2)},
...
NrHelper::EnableDlPhyTrace (void)
{
  ...
  NS_LOG_INFO ("EnableDlPhyTrace called");
...
{
  NS_LOG_INFO ("EnableGnbPhyCtrlMsgsTraces called");
...
{
  NS_LOG_INFO ("EnableGnbMacCtrlMsgsTraces called");  
...
{
  NS_LOG_INFO ("EnableUePhyCtrlMsgsTraces called");  
...
{
  NS_LOG_INFO ("EnableUeMacCtrlMsgsTraces called");
  ...
  NS_LOG_INFO ("second call to be called (inside EnableUeMacCtrlMsgsTraces) ");
...
{
  NS_LOG_FUNCTION_NOARGS ();
  NS_LOG_INFO ("EnableUlPhyTrace called");  
  ...
  // Config::Connect ("/NodeList/*/DeviceList/*/BandwidthPartMap/*/NrGnbPhy/SpectrumPhy/RxPacketTraceEnb",
  //                  MakeBoundCallback (&NrPhyRxTrace::UlSinrTraceCallback, m_phyStats));
...
{
  NS_LOG_FUNCTION_NOARGS ();
  NS_LOG_INFO ("EnableEnbPacketCountTrace called");  
...
{
  NS_LOG_FUNCTION_NOARGS ();
  NS_LOG_INFO ("EnableUePacketCountTrace called ...");
...
{
  NS_LOG_FUNCTION_NOARGS ();
  NS_LOG_INFO ("EnableTransportBlockTrace called");  
...
{
  NS_LOG_INFO ("EnableRlcTraces called");  
...
{
  NS_LOG_INFO ("EnablePdcpTraces called ...");
