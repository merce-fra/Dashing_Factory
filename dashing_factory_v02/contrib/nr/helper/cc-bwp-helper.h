...
struct BandwidthPartInfo
{
  ...
  enum Scenario
  {
	...
	InF_SL,  //!< InF_SparseLow
	InF_SL_nLoS, //!< Sparse Low, where all the nodes will not be in Line-of-Sight with low density
	InF_DL,  //!< InF_DenseLow
	InF_DL_nLoS,//!< Dense Low, where all the nodes will not be in Line-of-Sight with high density
	InF_SH,  //!< InF_SparseHigh
	InF_SH_nLoS,//!< Sparse High, where all the nodes will not be in Line-of-Sight with low density
	InF_DH,  //!< InF_DenseHigh
	InF_DH_nLoS,//!< Dense Low, where all the nodes will not be in Line-of-Sight with high density
