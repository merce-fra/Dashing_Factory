...
BandwidthPartInfo::GetScenario () const
{
  ...
  static std::unordered_map <Scenario, std::string, std::hash<int>> lookupTable
  {
    ...
    { V2V_Urban, "V2V-Urban" },
	// Indoor Factory - iTEAM UPV
	{ InF_SL, "InF-SparseLow" },
	{ InF_SL_nLoS, "InF-SparseLow"},
	{ InF_DL, "InF-DenseLow" },
	{ InF_DL_nLoS, "InF-DenseLow"},
	{ InF_SH, "InF-SparseHigh" },
	{ InF_SH_nLoS, "InF-SparseHigh"},
	{ InF_DH, "InF-DenseHigh" },
	{ InF_DH_nLoS, "InF-DenseHigh"},
  };
