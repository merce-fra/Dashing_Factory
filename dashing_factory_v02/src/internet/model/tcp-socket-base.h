...
class TcpSocketBase : public TcpSocket
{
  public:
     ...
     * \brief Callback pointer for RTT trace chaining
     */
    TracedCallback<Time, Time> m_lastRtoTrace;
    ...
    /**
     * \brief Callback function to hook to TcpSocketState rto
     * \param oldValue old rtt value
     * \param newValue new rtt value
     */
    void UpdateRto(Time oldValue, Time newValue);
  ...
  protected:
    ...
    std::map<std::string, std::string> m_tcp_traceFiles;
    ...
    std::string m_rttOutDir{"./"};      //!< outdir to log RTTs
