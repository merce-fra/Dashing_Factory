    ...
    static TypeId tid =
        TypeId("ns3::TcpSocketBase")
            ...
            .AddAttribute("LimitedTransmit",
                          ...
                          MakeBooleanChecker())
            .AddAttribute("RTTOutDir",
                          "Output Directory to log RTTs",
                          StringValue("./"),
                          MakeStringAccessor(&TcpSocketBase::m_rttOutDir),
                          MakeStringChecker())
            .AddAttribute("UseEcn",
    ...
    : TcpSocket()
{
    ...
    /// ok = m_tcb->TraceConnectWithoutContext("RTO", MakeCallback(&TcpSocketBase::UpdateRto, this));
    /// NS_ASSERT(ok == true);
                         ...
                         Ptr<Ipv4Interface> incomingInterface)
{
    ...
    /// NS_INFO("Socket " << this << " forward up " << m_endPoint->GetPeerAddress() << ":"
...
TcpSocketBase::EstimateRtt(const TcpHeader& tcpHeader)
{
    ...
    if (!m.IsZero())
    {
        ...
        /// NS_INFO("(EstimateRtt) " << Simulator::Now()  << " : m_tcb->m_lastRtt = " << m_tcb->m_lastRtt);
    }
}
                               ...
                               TcpSocketState::TcpCongState_t newValue)
{
    ...
    NS_LOG_INFO ("UpdateCongState called wiiww........");
}
                              ...
                              TcpSocketState::EcnState_t newValue)
{
    ...
    NS_LOG_INFO ("UpdateEcnState called .wiiww.......");    
}
...
void
TcpSocketBase::UpdateRto(Time oldValue, Time newValue)
{
    m_lastRtoTrace(oldValue, newValue);
}
