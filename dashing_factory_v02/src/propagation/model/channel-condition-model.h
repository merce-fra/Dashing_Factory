...
protected:
  ...
  */
  ...
  //Ptr<PointerValue> r_density; //density variable for InF - Andrea
private:
  /**
...
/**	INDOOR FACTORY - SPARSE CLUTTER LOW BS- iTEAM UPV
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory - Sparse Low scenario
 *
 * Computes the channel condition following the specifications for the
 * InF-SL scenario reported in Table 7.4.2-1 of 3GPP TR 38.901
 */
...
public:
  ...
  //Parameter to get clutter density
  double r_density_SL;
  /**
...
/**	INDOOR FACTORY - DENSE CLUTTER LOW BS- iTEAM UPV
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory - Dense Low scenario
 *
 * Computes the channel condition following the specifications for the
 * InF-DL scenario reported in Table 7.4.2-1 of 3GPP TR 38.901
 */
...
public:
  ...
  //Parameter to obtain clutter density
  double r_density_DL;
  /**
...
/**	INDOOR FACTORY - SPARSE CLUTTER HIGH BS- iTEAM UPV
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory - Sparse High scenario
 *
 * Computes the channel condition following the specifications for the
 * InF-SH scenario reported in Table 7.4.2-1 of 3GPP TR 38.901
 */
...
public:
  ...
  //Parameter to obtain clutter density
  double r_density_SH;
  //Parameter to obtain clutter height
  double hc_SH;
  /**
...
/**	INDOOR FACTORY - DENSE CLUTTER HIGH BS- iTEAM UPV
 * \ingroup propagation
 *
 * \brief Computes the channel condition for the Indoor Factory - Dense High scenario
 *
 * Computes the channel condition following the specifications for the
 * InF-DH scenario reported in Table 7.4.2-1 of 3GPP TR 38.901
 */
